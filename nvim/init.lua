...
vim.keymap.set("t", "<ESC><ESC>", "<C-\\><C-n>", { noremap = true, desc = "Terminal escape" })
...
require("lazy").setup({
	...
	},
	{
		...
		config = function()
			...
			wk.setup(vim.keymap.set("n", "<leader>hk", "<Cmd>WhichKey<CR>", { desc = "Key help" }))
			wk.register({
				["<leader>f"] = {
					name = "Find",
				},
	...
	-- LSP Configuration
	{ "neovim/nvim-lspconfig", cond = no_vscode }, -- LSP configuration
	{
